/*
  ds1307nvram - Example of using the non-volatile RAM storage on
  the DS1307.  You can write up to 56 bytes from address 0 to 55.
  Data will be persisted as long as the DS1307 has battery power.
  Requires RTClib.cpp and RTClib.h from Adafruit.
  
  Added ENERGIA after #ifdef in RTClib.cpp to get it to compile

  Nothe that this is a 5V module and required logic conversion.
